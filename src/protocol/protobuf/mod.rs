...
pub use negotiation::{ProtocolNegotiator, ProtocolType, NegotiationResult};
...
impl ProtobufMetrics {
    pub fn update_message_processed(&mut self, size: usize, parse_time_us: f64, serialize_time_us: f64) {
        ...
        self.avg_serialize_time_us = (self.avg_serialize_time_us * (count - 1.0) + serialize_time_us) / count;
    }
