...
use crate::protocol::protobuf::{PROTOBUF_MAGIC, PROTOBUF_VERSION, ProtobufError, ProtobufResult};
...
impl ProtocolNegotiator {
    ...
    pub fn negotiate(&self, client_request: &[u8]) -> ProtobufResult<NegotiationResult> {
        ...
        match detected_protocol {
            ...
            ProtocolType::Toon => {
                Err(ProtobufError::NegotiationFailed {
    ...
    pub fn create_negotiation_response(&self, result: &NegotiationResult) -> Bytes {
        match result.protocol {
            ...
            ProtocolType::Toon => {
                Bytes::from_static(b"ERROR TOON not implemented\n")
            }
        }
    }
