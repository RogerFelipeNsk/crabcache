...
use super::{ToonPacket, ToonType, StringInterner};
...
impl ToonEncoder {
    ...
    fn encode_value(&mut self, value: &ToonType, buf: &mut BytesMut, use_interning: bool) -> Result<(), String> {
...
impl ToonEncoder {
    ...
    pub fn encode_response(&mut self, response: &crate::protocol::commands::Response) -> Result<BytesMut, String> {
        let toon_value = match response {
            ...
            crate::protocol::commands::Response::Value(bytes) => {
                ToonType::Bytes(bytes.clone())
            },
            crate::protocol::commands::Response::Stats(stats) => {
                ToonType::String(stats.clone())
            },
        };
    ...
    pub fn encode_command(&mut self, command: &crate::protocol::commands::Command) -> Result<BytesMut, String> {
